 ...
 * 
 */
@WebServiceClient(name = "CalculatorWebService", targetNamespace = "http://demo32.curso/", wsdlLocation = "http://localhost:8084/Demo_32_WS/CalculatorWebService?wsdl")
    ...
    extends Service
{
    ...
    private final static QName CALCULATORWEBSERVICE_QNAME = new QName("http://demo32.curso/", "CalculatorWebService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:8084/Demo_32_WS/CalculatorWebService?wsdl");
    ...
    public CalculatorWebService getCalculatorWebServicePort() {
        return super.getPort(new QName("http://demo32.curso/", "CalculatorWebServicePort"), CalculatorWebService.class);
    }
    ...
    public CalculatorWebService getCalculatorWebServicePort(WebServiceFeature... features) {
        return super.getPort(new QName("http://demo32.curso/", "CalculatorWebServicePort"), CalculatorWebService.class, features);
    }
